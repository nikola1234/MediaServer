...
public:
    ...
    void calc(const Region& region, const Mat& frame,void* videoHandler);
...
private:
    ...
    void targetUpdate(map<int, Target>& targets,void* videoHandler);

public:
    void analyze(const Mat& frame, Mat& mymask, map<int, Target>& targets,void* videoHandler);
};
